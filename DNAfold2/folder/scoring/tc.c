...
int main()
{
	...
	tempfile2=fopen("min_conf.dat","r+");
	...
	for(int k=0;k<N;k++)
	{
		j=0;
		if(i==0)
			fprintf(outfile,"CRYST1    0.000    0.000    0.000  90.00  90.00  90.00 P %d           1\n",k+1);
		while(1)
		{
			if(feof(infile))
			{
			...
			{	
				...
				fprintf(outfile,"END\n");
				fprintf(outfile,"CRYST1    0.000    0.000    0.000  90.00  90.00  90.00 P 1           %d\n",k+1);
				chn=0;chnn='A';
				cn0=cn;
				i++;
				j=0;
